...
description: |
  A recreation of DuBois' "Proportion of Freemen and Slaves Among American Negroes" for #TidyTuesday week of Feb 16, 2021
author:
  - name: Elizabeth Shin
...
```{r, include = FALSE}
#Purpose is to download my own copy of the .csv file, not relevant for replicating the graph
write_csv(freed_slaves, "freed_slaves.csv")
fr_sl = read_csv("freed_slaves.csv")
```
...
Check out my [GitHub](https://github.com/Eli2022/TidyTuesday) to view the source code!
...
a <- ggplot(fr_sl, aes(x=factor(Year), y=Free, group = 1)) +
  ...
  theme(axis.text = element_blank(),
        ...
        plot.background = element_rect(fill = "#e4d7ca")) +
